...
@section('title', 'BBWS-CITARUM | Publikasi | Informasi')
...
@section('content')
<x-jumbotron name="Kondisi Muka Air Waduk & Embung" />
<x-running-text />

<x-bread-crumb name="Kondisi Muka Air Waduk & Embung" />
                ...
                <div class="card-body p-4">
                    <div class="row p-0">
                        ...
                        <div class="col-12 col-lg-9 p-0">
                            <div>
                                <h4 class="card-title text-4 font-weight text-primary">Tampilan Website</h4>
                            </div>
