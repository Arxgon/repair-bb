...
@section('title', 'Standar Pelayanan BBWS Citarum')
...
@section('content')
<x-jumbotron name="Standar Pelayanan BBWS Citarum" />
<x-running-text />

<x-bread-crumb name="Standar Pelayanan BBWS Citarum" />
                ...
                <div class="card-body p-4">
                    <div class="row p-0">
                        ...
                        <div class="col-12 col-lg-9 p-0">
                            <div>
                                <h4 class="card-title text-4 font-weight text-primary">Standar Pelayanan BBWS Citarum</h4>
                            </div>
                            <p class="card-text ">17 April 2024</p>
                        </div>
                        <div class="col-12 col-lg-2 p-0">
                            <a href="{{ asset('assets/pdf/SK PENETAPAN STANDAR PELAYANAN_2024.pdf') }}" download
